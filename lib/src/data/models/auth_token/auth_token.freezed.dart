...
mixin _$AuthToken {
 ...
 String? get accessToken; String? get refreshToken; String get nameUser; String get email; String get phone; bool get isPremium;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,nameUser,email,phone,isPremium);

@override
String toString() {
  return 'AuthToken(accessToken: $accessToken, refreshToken: $refreshToken, nameUser: $nameUser, email: $email, phone: $phone, isPremium: $isPremium)';
}
...
@useResult
$Res call({
 String? accessToken, String? refreshToken, String nameUser, String email, String phone, bool isPremium
});
...
/// Create a copy of AuthToken
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = freezed,Object? refreshToken = freezed,Object? nameUser = null,Object? email = null,Object? phone = null,Object? isPremium = null,}) {
...
class _AuthToken implements AuthToken {
  const _AuthToken({this.accessToken, this.refreshToken, this.nameUser = '', this.email = '', this.phone = '', this.isPremium = false});
...
/// Create a copy of AuthToken
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = freezed,Object? refreshToken = freezed,Object? nameUser = null,Object? email = null,Object? phone = null,Object? isPremium = null,}) {
