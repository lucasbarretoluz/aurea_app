...
class _Initial implements NotificationListState {
  const _Initial();
...
class _Loading implements NotificationListState {
  const _Loading();
...
class _Loaded implements NotificationListState {
...
@override
String toString() {
  return 'NotificationListState.loaded(notifications: $notifications)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $NotificationListStateCopyWith<$Res> {
...
class _Error implements NotificationListState {
...
@override
String toString() {
  return 'NotificationListState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $NotificationListStateCopyWith<$Res> {
