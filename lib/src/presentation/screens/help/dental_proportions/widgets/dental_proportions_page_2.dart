...
class DentalProportionsPage2 extends StatelessWidget {
      ...
      children: [
        Positioned(
          ...
          child: Transform.scale(
            scale: 1.0,
            child: Image.asset(
              'assets/images/smile_gingival_contour.png',
              fit: BoxFit.contain,
            ),
          ),
        ),
              ...
              children: [
                Column(
                  children: [
                    ...
                    const Text(
                      'Posicione a linha horizontal sobre os \nzênites gengivais dos incisivos centrais e \ncaninos',
