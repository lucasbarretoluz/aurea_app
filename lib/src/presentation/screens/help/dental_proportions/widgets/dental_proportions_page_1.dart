...
class DentalProportionsPage1 extends StatelessWidget {
      ...
      children: [
        Positioned(
          ...
          child: Transform.scale(
            scale: 1.0,
            child: Image.asset(
              'assets/images/smile_axle_dental.png',
              fit: BoxFit.contain,
            ),
          ),
        ),
              ...
              children: [
                Column(
                  children: [
                    ...
                    const Text(
                      'O eixo deve se inclinar para mesial na sua \nparte mais incisal e as angulações devem \naumentar em direção distal.',
